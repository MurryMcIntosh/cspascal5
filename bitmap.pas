...
{ Unit Bitmap, Version 1.20, Copr. 1994,95 Matthias K봯pe
...
implementation { 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴 }
...
{ Low-level bitmap functions 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴
}
var
  Bmp2ImgRowProc: Word;
...
{ Low-level palette functions 컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴
}
var
  GetDevPalProc: Word;
